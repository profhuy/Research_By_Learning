...
(Table~VII in~\cite{fan2020chaff}).
...
41.0\% (Table~2 in~\cite{bo2024chatbr})---but evaluated improvements
exclusively through automated semantic-similarity metrics, without
any form of human agreement measurement.
...
Sec.~4.4.2 in~\cite{saha2026bugscribe}),
...
In summary, all three studies that employ Kappa are restricted to
platform-specific contexts (Android or Mojira) and measure only
human--human agreement, leaving LLM-versus-developer agreement on
general open-source repositories unexplored.
...
\textbf{Study} &
  ...
  \textbf{Gen.\ OSS} \\
\hline
Fan et al.~\cite{fan2020chaff}             & 2020 & $\times$     & $\times$     & $\times$  & $\checkmark$ \\
Song \& Chaparro~\cite{song2020bee}        & 2020 & $\checkmark$ & $\times$     & $\times$  & $\checkmark$ \\
Bo et al.~\cite{bo2024chatbr}              & 2024 & $\checkmark$ & $\checkmark$ & $\times$  & $\checkmark$ \\
Acharya \& Ginde~\cite{acharya2025enhance} & 2025 & $\times$     & $\checkmark$ & $\times$  & $\checkmark$ \\
Mahmud et al.~\cite{mahmud2025astrobr}     & 2025 & S2R only     & $\checkmark$ & H--H      & $\times$ \\
Akyol et al.~\cite{akyol2026improbr}       & 2026 & $\checkmark$ & $\checkmark$ & H--H      & $\times$ \\
Saha et al.~\cite{saha2026bugscribe}       & 2026 & $\checkmark$ & $\checkmark$ & H--H      & $\times$ \\
\hline
\textbf{This study}                        & 2026 & $\checkmark$ & $\checkmark$ & \textbf{LLM-Dev} & $\checkmark$ \\
\hline
\end{tabular}
\vspace{4pt}
